...
void displayLockScreen()
{
  ...
  display.drawRect(32,0,128,128,WHITE);
  ...
  display.drawBitmap(62,35,icon,60,60,WHITE);
  lcd.setCursor(0,0);
    lcd.print("locked                ");
    lcd.setCursor(0,1);
    lcd.print("                      ");
...
void displaysubhan()
{
  display.setCursor(67,75);
  display.setTextColor(WHITE); 
  display.setTextSize(2);
  display.print("subhan!!");
}

void displayriyaz()
{
  display.setCursor(52,75);
  display.setTextColor(WHITE); 
  display.setTextSize(2);
  display.print("riyaz!!");
  lcd.setCursor(0,0);
...
void loop() {
  ...
  if(fingerprintID == 1)
  {
    ...
    display.drawBitmap(62,35,icon,60,60,GREEN);
    delay(2000);
